...
public class ReplyMsgServiceImpl implements ReplyMsgService {
    ...
    public AIService chooseAiService() {
        ...
        if (botconfig == null || botconfig.getAiType() == null || botconfig.getAiType().isBlank()) {
            throw new RuntimeException("aiType 未配置");
        }
        return AiServiceFactory.getAiServiceByType(botconfig.getAiType());
    }
